...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($email == "admin123@gmail.com" && $password=="Admin") {
      ...
      echo "<script>alert('Admin login successful.'); window.location.href='dashboard.html';</script>";
    }
   if ($result->num_rows > 0) {
      ...
      $hashed_password = $row['password'];
          ...
          // You might want to set session variables or perform other actions here.
      } else {
        ...
        <form class="form" action="" method="POST">
          ...
          <footer class="form-footer">
              ...
              <div>
                ...
                <a href="Sinup.php" class="form-link">Sing Up</a><br>
                <a href="Login.php" class="form-link">Admin Login</a>
